...
class Ui_TestingSetupDesign(object):
    def setupUi(self, TestingSetupDesign):
        ...
        self.label_4 = QtWidgets.QLabel(TestingSetupDesign)
        ...
        self.label_6 = QtWidgets.QLabel(TestingSetupDesign)
        ...
        self.consigne = QtWidgets.QLabel(TestingSetupDesign)
        ...
        self.label_5 = QtWidgets.QLabel(TestingSetupDesign)
        ...
        self.all_values = QtWidgets.QTextEdit(TestingSetupDesign)
        self.all_values.setGeometry(QtCore.QRect(220, 290, 231, 211))
        self.all_values.setObjectName("all_values")
        self.valid_values = QtWidgets.QTextEdit(TestingSetupDesign)
